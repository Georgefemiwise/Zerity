...
export default function TopNavigationBar() {
	return (
		<div className='mx-auto flex h-16 max-w-screen-xl items-center gap-8 px-4 sm:px-6 lg:px-8 border-b border-white/80'>
			<a
			...
			<div className='flex flex-1 items-center justify-end md:justify-between'>
				...
				<div className='flex items-center gap-4'>
					<a
						className='inline-flex items-center  rounded border-2 border-white/20 bg-white/20 p-2 text-sm font-medium text-white transition-colors hover:border-primary hover:text-white  '
						href='#'
						target='_blank'
						rel='noreferrer'>
						<svg
...
// <a
//   className="inline-flex items-center gap-2 rounded border-2 border-[#ea4c89] bg-[#ea4c89] px-5 py-3 text-sm font-medium text-white transition-colors hover:bg-transparent hover:text-[#ea4c89] focus:outline-none focus:ring active:opacity-75"
//   href="/dribbble"
//   target="_blank"
//   rel="noreferrer"
// >
